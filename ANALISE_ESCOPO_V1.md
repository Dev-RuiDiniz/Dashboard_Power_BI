...
O projeto evoluiu de forma relevante: o workspace agora esta operacional, os modulos principais de plataforma foram integrados ao runtime, a tela de perfil passou a ter backend real, o frontend deixou de depender de leitura direta do Supabase para dashboard, notifications, exports e settings, e as definicoes administrativas de relatorios passaram a ter persistencia real no backend. Mesmo assim, o repositorio **ainda nao entrega o V1 completo do PDF**. A plataforma hoje tem uma base funcional centralizada na API, mas continua com lacunas importantes em BI avancado, export pipeline aderente ao escopo, 2FA e varios pontos do stack descrito no `AGENTS.md`.
...
| RELAT.   | Parcial | Catalogo, visualizacao, filtros, gestao admin basica e persistencia real das definicoes | Exportacao completa do PDF ainda nao fechou                                                                     | Favoritos, export aderente e demais fluxos do escopo                            |
...
- `RELAT.`: catalogo, query e definicoes administrativas agora usam persistencia real; o modulo continua parcial por causa de exports, favoritos e aderencia mais ampla ao PDF.
...
- **Debitos de escopo**: continuam relevantes, principalmente em BI avancado, exportacao aderente ao PDF e seguranca do MVP completo.
...
1. Fechar exportacoes aderentes ao PDF.
2. Consolidar permissoes, auditoria, settings e persistencias restantes de platform.
