...
| BI       | Parcial | Dashboard home com KPIs, resumo por setor, payload consolidado, charts reais via API e drill-down inicial por KPI                          | Ainda faltam drill-down rico, dashboards personalizados e editor visual                            | Drill-down multi-dimensao, personalizacao, favoritos e editor visual            |
...
- `BI`: os KPIs do dashboard home evoluiram para payload consolidado, charts reais e drill-down inicial, mas o BI descrito no PDF ainda nao foi entregue por falta de exploracao mais rica e personalizacao.
