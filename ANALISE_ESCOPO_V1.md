...
| T07  | Dashboard interativo com graficos, drill-down e interacao rica   | Parcial  | `apps/web/package.json`, `apps/web/src/components/dashboard/dashboard-home.tsx`, `apps/api/src/platform/dashboard/*`, `apps/web/src/lib/platform-api.ts`                                                                                                                                                                                                                                      | A home agora tem charts reais e payload consolidado de BI, mas ainda nao ha drill-down nem interacao rica aderente ao PDF.                |
...
| BI       | Parcial | Dashboard home com KPIs, resumo por setor, payload consolidado e charts reais via API                                                      | Ainda faltam drill-down, dashboards personalizados e editor visual                                 | Drill-down, personalizacao, favoritos e editor visual                           |
...
- `BI`: os KPIs do dashboard home evoluiram para payload consolidado e charts reais, mas o BI descrito no PDF ainda nao foi entregue por falta de drill-down e personalizacao.
