...
| RELAT.   | Parcial | Catalogo, visualizacao, filtros, gestao admin basica, persistencia real das definicoes, favoritos e pipeline de exportacao de relatorios   | Cobertura mais ampla do PDF ainda nao fechou                                                       | Ampliar favoritos, dashboards/exports e demais fluxos do escopo                 |
...
- `RELAT.`: catalogo, query, definicoes administrativas, favoritos e exportacao de relatorios agora usam backend real; o modulo continua parcial pela aderencia mais ampla do PDF.
